 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_partner_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff
        $elename = 'partner';
        $elepath = $this->get_pathfor('/partner'); // we used get_recommended_name() so this works
     ...
     */
    public function process_partner($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_partner', $data);
            // Create mapping
            $this->set_mapping('question_partner', $oldid, $newitemid);
        }
    }

    public function process_question_hint()
    {	
